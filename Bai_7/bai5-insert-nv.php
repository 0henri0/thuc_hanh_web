...
<body>
	...
	<table>
	<form name="frmPHP" method="post" action="bai5-insert-nv-1.php">
			<tr>
			...
			<tr>
				<td align="left">
					<input type="text" name="id_nv" size="25" required class="textbox" maxlength="6">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td align="left">
					<input type="text" name="tennv" size="25" required class="textbox" maxlength="50">
				</td>
			</tr>
			<tr>
